...
Example input is a fetal brain MRI taken from the [FeTA dataset](http://neuroimaging.ch/feta).

For convenience, the entire dataset can be obtained from ipfs://QmNh35SJMxTE3dXBtaJgbBxjyCn7tiFJm1ircGQfQXffb1
...
License - FetA- Fetal Tissue Annotation and Segmentation Dataset
